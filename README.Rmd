...
Alternatively, the `bactgrowth.txt` can be downloaded from [here](https://github.com/tpetzoldt/growthrates/tree/master/data). The data can be read using the following code.
...
For more instructions, please refer to the [vignette](https://cran.r-project.org/web/packages/ipolygrowth/vignettes/ipolygrowth_vignette.html).
