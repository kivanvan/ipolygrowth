...
The package will be submitted to CRAN. For now, you can install the ipolygrowth from [GitHub](https://github.com/) with:
...
The example data comes from the [growthrates](https://cran.r-project.org/web/packages/growthrates/index.html) package.
