...
Expected outputs are shown in the rendered version of [the ipolygrowth vignette] (https://cran.r-project.org/web/packages/ipolygrowth/vignettes/ipolygrowth_vignette.html) on CRAN.  
